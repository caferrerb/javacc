...
public class MyNewGrammar implements MyNewGrammarConstants {
  public void run(String codigo) throws Exception {
        MyNewGrammar.dibujo();
  }

  static final public void dibujo() throws ParseException {
    label_1:
    while (true) {
 ...
 int a =0;
  ...
  static final public void punto() throws ParseException {
    jj_consume_token(PUNTO);
    jj_consume_token(PAR_ABIERTO);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFICADOR:
      jj_consume_token(IDENTIFICADOR);
      break;
    ...
    jj_consume_token(PAR_CERRADO);
  }

  static final public void circulo() throws ParseException {
  ...
  static final public void rectangulo() throws ParseException {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2c00,0x2c00,0x2200,0x2200,0x2200,0x2200,0x2200,};
   }
